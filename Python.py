...
# print('Хорошо добро пожаловать! :',num)
# queshon = input('Вы хотите что то создать ? \n \t Game ?   \n \t List ?  \n \t None ? \n \t:',)
# if queshon == 'Game':
#     print('Давайте сделаем игру, угадай число!')
#     num1 = int(input('Введи число от 1 до 100 '))
#     print('Хорошо молодец.')
#     num2 = random.randint(1,100)
#     if num1 > num2:
#         print('Ты выграл твое число :',num1,' больше чем мое.',num2)
#     elif num1 == num2:
#         print('Наши числа одинаковы, ничья!')
#     else:
#         num1 < num2
#         print('Ты проиграл неудачник','мое число :',num2)
# elif queshon == "list":
#     count = 0
#     user_list = []
#     message = input('Введи длину  списка, сколько елементов будут там')
#     while int(message) > count:
#         elm = 'Element : '
#         user_list.append(input(elm))
#         count += 1
#         print('Ващ список содержит следующие елменты :',user_list)
# else:
#     queshon != 'Yes'
#     print('Хорошо пока')
#     exit()
...
# # Проверка на итерируемые обьекты можно ли обьект прочитать построчно метод hasattr(,'__iter__') iterr это метод
# if hasattr([1,2,3,4,5,10],'__iter__'):
#     print(True)
# else:
#     print(False)
...
#  # Генератор - это итератор он создаеться функцией  отличие от итерируемого обьекта в том что не хранит  элементы в памяти он генерирует их при вызове
# #  yield  автоматически превращет функцию в генератор
# def generator (x:int):
#     for i in range(x+1): # +1 добовляет значени 5 ** 2 = 25
#         yield i**2
...
# 1 # #Напишите программу, которая принимает строку латинских букв и выводит из неё только заглавные буквы.
# num = input('Ведите строку :')
# for x in num:
#     if x.isupper():
#         print(x)


# 2 # Напишите скрипт, который выводит на экран случайное число от 1 до 6, имитируя бросок кубика-шестигранника.
# import  random
# num = random.randint(1,6)
# print(num)

## Надежный пароль
# # Сгенириируйте надежный пароль

#
# import  random
# digit = '123456789'
# lat_upper = 'ASDQWEJKLTI'
# lat_lower = 'qwertyuiofkd'
# spec_symb = '!@#$%^&'
# passw = ''
#
# for i in range(7):
#     passw += random.choice(lat_upper)
# passw += random.choice(digit)
# passw += random.choice(lat_lower)
# passw += random.choice(spec_symb)
#
# print(passw)
